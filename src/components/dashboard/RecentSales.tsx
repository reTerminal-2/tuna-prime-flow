  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center">
        ...
        <div className="ml-4 space-y-1">
          <p className="text-sm font-medium leading-none">Maria Luna</p>
          <p className="text-sm text-muted-foreground">maria.luna@email.com</p>
        </div>
      ...
      <div className="flex items-center">
        ...
        <div className="ml-4 space-y-1">
          <p className="text-sm font-medium leading-none">Isabella Santos</p>
          <p className="text-sm text-muted-foreground">
